...
# no interactive menu on hosts without a terminal (Railway, docker, systemd, nohup)
HEADLESS = os.environ.get("LAZYFARMERS_HEADLESS", "").lower() in ("1", "true", "yes") or not sys.stdin.isatty()
